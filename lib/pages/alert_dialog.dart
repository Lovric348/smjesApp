...
class AlertDial extends StatefulWidget {
  ...
  const AlertDial({super.key, required this.data});
...
class _AlertDialState extends State<AlertDial> {
  ...
  void initState() {
    ...
    if (widget.data == 11) {
      _naslov = 'Upute';
      _text =
          ' Krvavice (krvenjače) tradicionalno se prave od kože i ostalih organa koji se skupa sa kostima i mesom kuhaju u velikom loncu.'
      ...
      _naslov = 'Upute';
      _text =
          ' Za čvarake potrebno je pripremiti svježu slaninu narezanu na kocke, veličine po Vašem izboru'
