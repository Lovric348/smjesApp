...
class LjutiScreen extends StatefulWidget {
  final int data;
  ...
  const LjutiScreen({super.key, required this.data});

  @override
  // ignore: library_private_types_in_public_api
  _LjutiScreenState createState() => _LjutiScreenState();
}

class _LjutiScreenState extends State<LjutiScreen> {
  String _naslov = '';
  double _slatka = 0.0;
  double _ljuta = 0.0;
  double _sol = 0.0;
...
//_textController is initialized as a TextEditingController which will be used to control the text field's behavior.
  ...
  void initState() {
    super.initState();
    if (widget.data == 3) {
      _naslov = 'Kobasica ljuti';
      _slatka = 0.003;
      _ljuta = 0.007;
      _sol = 0.019;
      _luk = 0.01;
    } else if (widget.data == 7) {
      _naslov = 'Kulenova seka ljuti';
      _slatka = 0.003;
      _ljuta = 0.009;
      _sol = 0.02;
      _luk = 0.01;
    } else if (widget.data == 12) {
      _naslov = 'Kulen ljuti';
      _slatka = 0.003;
      _ljuta = 0.01;
      _sol = 0.02;
